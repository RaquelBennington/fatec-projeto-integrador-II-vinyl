      ...
      <div class="container ml-auto mr-auto flex flex-wrap items-start">
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 pl-5 pr-5 mb-5 lg:pl-2 lg:pr-2 ">
          ...
          >
            ...
            <div class="rounded-lg p-4 bg-white flex flex-col border-black border border-t border-b border-r">
              <div>
                <h5 class="text-black text-2 font-bold leading-none">
                  Stevie Wonder
                </h5>
                <p class="text-base text-gray-600 leading-none">Innervisions (1973) </p>
              </div>
